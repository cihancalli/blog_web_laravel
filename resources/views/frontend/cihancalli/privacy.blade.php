...
@section('titleCihancalli','Privacy Policy')
            ...
            <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                <div class=" mb-5">
                    ...
                    <p>
                        ...
                        how <a
                                href="{{route("home")}}">{{route("home")}}</a> ("Company", "we", "us") collects and uses
                        personal information through its
                        website located at <a
                                href="{{route("home")}}">{{route("home")}}</a> ("Website"). This Privacy Policy also
                        explains how
                    ...
                    <h2>Security of Your Cihancallial Information</h2>
                    <p>
