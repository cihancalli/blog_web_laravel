...
@section('titleZerdaSoftware','Home')
@section('contentZerdaSoftware')
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8 col-lg-10 text-center">
                        <div data-aos="fade-up">
                            ...
                            <p class="page-header-ui-text">We are a group of creatives and developers who
                                design, build, and optimize brands and digital experiences.</p>
                        </div>
                        <a class="btn btn-primary fw-500" href="#get-started" data-aos="fade-up"
        ...
        <div class="container px-5">
            <div class="row gx-5 text-center">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <h2>Develop</h2>
                    <p class="mb-0">Our award winning development team creates personalized digital
                        experiences</p>
                </div>
                <div class="col-lg-4">
                    <div class="icon-stack icon-stack-xl bg-gradient-primary-to-secondary text-white mb-4"><i
                            data-feather="truck"></i></div>
                    <h2>Deliver</h2>
    ...
    <section class="bg-light py-10">
        <div class="container px-5">
            <div class="row gx-5 brands text-gray-500 align-items-center mb-5">
                ...
                <div class="col-6 col-sm-4 col-lg-2 d-flex justify-content-center mb-5 mb-lg-0">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 2499.17 585">
                        <title>product-hunt</title>
                        <g id="Page-1">
                            <g id="product-hunt-logo-horizontal-orange">
                                <path
                                    d="M585.54,292.5C585.54,454.11,454.64,585,293,585S.54,454.11.54,292.5,131.43,0,293,0s292.5,130.89,292.5,292.5m-253.5,0H249.16V204.75H332a43.88,43.88,0,0,1,0,87.75m0-146.25H190.66v292.5h58.5V351H332a102.38,102.38,0,0,0,0-204.75"
                    ...
                    <div class="card lift mb-n15">
                        <div class="card-body p-2">
                            <div class="video overlay bg-img-cover rounded"
                                 style="background-image: url('https://source.unsplash.com/wD1LRb9OeEo/1500x900')">
                                <a class="video-link"
                                   href="{{route('home')}}/frontend/zerdasoftware/dist/assets/video/video.mp4"
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-10">
                    <div class="display-6 text-center py-10 my-10 text-white">
                        ...
                        and how it
                        <span class="text-primary">functions.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container px-5 z-1">
            <div class="card mb-5" data-aos="fade-right">
                <div class="row g-0">
                    <div class="col-md-6"><img class="img-fluid"
                                               src="https://source.unsplash.com/6LBBOwkPzyQ/800x550" alt="..."/>
                    </div>
                    <div class="col-md-6">
                        <div
                            ...
                            <a class="btn btn-outline-dark fw-500" href="{{route('home')}}">View Case Study</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card mb-5" data-aos="fade-left">
                <div class="row g-0">
                    ...
                    <div class="col-md-6 order-0 order-md-1"><img class="img-fluid"
            ...
            <div class="card" data-aos="fade-right">
                <div class="row g-0">
                    <div class="col-md-6"><img class="img-fluid"
                                               src="https://source.unsplash.com/7LNatQYMzm4/800x550" alt="..."/>
                    </div>
                    <div class="col-md-6">
                        <div
                            class="card-body d-flex align-items-center justify-content-center h-100 flex-column">
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10 text-center my-10 py-10">
                    ...
                    <p class="lead text-gray-500 mb-4">We'd love to hear from you about your branding and
                        digital needs. We are currently accepting new clients.</p>
                    <a class="btn btn-primary fw-500" href="{{route('home')}}">Contact us</a>
                </div>
            </div>
        </div>
